...
- BFF, Scheduling Service e AI Orchestrator possuem fundações multi-tenant. Agenda Atendly e Minha Agenda operam atrás do mesmo `CalendarProvider`; AI Orchestrator usa LangChain para modelo e tools. LangGraph e RAG ainda não existem.
...
| AI Orchestrator    | `apps/ai-orchestrator`      | Fastify, TypeScript, Prisma/PostgreSQL e LangChain; conversas, handoff, IA e client do Scheduling Service |
