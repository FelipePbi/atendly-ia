...
| Ciclo de migração Tech Lead ↔ Developer via IA Loop: Goal vigente, baseline aceita, fechamento por commit | `migration/README.md`, `migration/MASTER_PLAN.md` e `migration/AGENT_ROLES.md` |
