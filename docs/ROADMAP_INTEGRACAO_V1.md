...
| GOAL 11 | BFF Public API V1 | GOAL 10 | COMPLETED |
| GOAL 12 | Frontend data layer | GOAL 11 | COMPLETED |
...
| GOAL 17 | Legacy cleanup | GOAL 16 | COMPLETED |
| GOAL 18 | Deploy + final architecture audit | GOAL 17 | IN_PROGRESS |
