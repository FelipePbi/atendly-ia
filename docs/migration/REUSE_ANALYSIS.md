...
| Cliente e serviço Scheduling | Cliente refeito no Goal006: pessoa por ID com telefone opcional e não exclusivo, responsável principal, notas e tags com autorização, criação só na confirmação; serviço continua com schema insuficiente | REFACTOR (cliente feito) | Contratos comerciais completos antes de consumers (Goal007); preferências e memória no Goal012; telas no Goal015 |
