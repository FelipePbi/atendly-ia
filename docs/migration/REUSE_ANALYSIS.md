...
| Cliente e serviço Scheduling | Cliente refeito no Goal006 (pessoa por ID, responsável, notas e tags com autorização, criação só na confirmação) e serviço refeito no Goal007 (quatro semânticas de preço, duração opcional com revisão, predicado operacional único, atributos do MVP, snapshot do acordo com total por regra única) | REFACTOR (feito) | Buffers na ocupação (Goal009), recorrência pela IA (Goal011), importação (Goal010), preferências e memória (Goal012), telas (Goal015) |
