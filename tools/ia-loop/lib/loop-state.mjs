...
const ALLOWED_TRANSITIONS = Object.freeze({
  ...
  DEVELOPER_QUEUED: ['DEVELOPER_RUNNING', 'HUMAN_REQUIRED', 'STOPPED'],
  DEVELOPER_RUNNING: ['REVIEW_REQUIRED', 'HUMAN_REQUIRED', 'STOPPED'],
  REVIEW_REQUIRED: ['REVIEWER_QUEUED', 'STOPPED'],
  REVIEWER_QUEUED: ['REVIEWER_RUNNING', 'HUMAN_REQUIRED', 'STOPPED'],
  REVIEWER_RUNNING: ['ACCEPTED', 'CHANGES_REQUIRED', 'HUMAN_REQUIRED', 'STOPPED'],
